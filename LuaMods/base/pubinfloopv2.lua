...
-- To loop your function, use RunNewLoop( function, argument ) (argument can be nil, If you don't need to pass any argument to function) 
-- (Note: RunNewLoop( function(), argument ) will be incorrect, unless function() returns function. Same applies to RunNewLoop( someclass:function(),argument ), 
-- use RunNewLoop(someclass.function,argument) instead. )
